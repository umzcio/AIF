...
2. PRIOR AGENT REPORTS (provided below) — findings from code analysis, accessibility audit, and optionally HECVAT assessment

You will produce THREE documents in a single JSON output. Each document is a markdown string.
...
=====================================================================
DOCUMENT 3: COMPLIANCE SUMMARY
=====================================================================

Write a one-page compliance summary for reviewers and decision-makers. Include:
...
5. **Risk Summary** — Scoring signals from Agent 1 (data sensitivity, blast radius, autonomy, builder comprehension)
6. **Recommended Actions** — Prioritized list of what must be fixed before production, derived from critical findings across all agents
7. **HECVAT Highlights** — If Agent 3 results are available, include key HECVAT responses. If not, note that HECVAT assessment was not performed.
