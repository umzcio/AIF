...
// Auth — all institution-specific values MUST come from environment variables
// AUTH_PROVIDER selects the SSO strategy: cas | oidc | saml | header | bypass
// AUTH_BYPASS=true is a legacy alias for AUTH_PROVIDER=bypass
export const AUTH_PROVIDER = process.env.AUTH_PROVIDER || (process.env.AUTH_BYPASS === "true" ? "bypass" : "cas");
export const CAS_BASE_URL = process.env.CAS_BASE_URL || "";
export const CAS_SERVICE_URL = process.env.CAS_SERVICE_URL || "";
export const CAS_LOGOUT_URL = process.env.CAS_LOGOUT_URL || (CAS_BASE_URL ? `${CAS_BASE_URL.replace("/cas", "")}/idp/profile/cas/logout` : "");
export const FRONTEND_URL = process.env.FRONTEND_URL || "";
export const AUTH_BYPASS = AUTH_PROVIDER === "bypass";
...
export const INSTITUTION_NAME = process.env.INSTITUTION_NAME || "";
export const INSTITUTION_DOMAIN = process.env.INSTITUTION_DOMAIN || "";
